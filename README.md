...
lab4_raw.sh - "сырая" версия итогового скрипта, в двух функциях нет проверки на отсутствие файла,
              но есть все остальные проверки. По-хорошему, некоторые проверки лучше всего вынести
              в отдельные функции, что и будет сделано в дальнейшем 
