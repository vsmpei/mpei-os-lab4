...
db_ok=0 # переменная-флаг для проверки содержимого файлов 
...
# проверка файла на существование (если find нашел такой файл, строка пути к нему не пустая)
# проверка файла на пустоту 
# проверка флага проверки содержимого файла, после того, как функция проверки отработала
...
while [[ $ok -eq 0 ]]; do # пока флаг проверки 0
	...
	if [[ "$s_sname" =~ ^[A-Z]{1}[a-z]{1,}$ ]]; then # сравниваем с шаблоном фамилию
		...
		echo -e "\n${RED}ОШИБКА: фамилия введена неверно! В фамилии не должно быть чисел и других символов! Фамилия должна начинаться с заглавной буквы и содержать в себе только буквы латинского алфавита!${NORMAL}"
...
#--------------------------------------------------------------------
# проверка содержимого файла для пунктов 1 и 2 
#--------------------------------------------------------------------
...
#--------------------------------------------------------------------
# проверка содержимого файла для пункта четыре
#--------------------------------------------------------------------
